    ...
    <div className="flex flex-col items-center w-full md:px-72">
        ...
        <div className='text-left'>
            ...
            <ul className='list-disc list-inside'>
                <li><strong>Titular: </strong>Chikin Wave SL</li>
                <li><strong>NIF/CIF: </strong>B56470388</li>
                <li><strong>Domicilio social: </strong>Calle del General Diaz Porlier 38 28001, Madrid</li>
                <li><strong>Teléfono: </strong>620788877</li>
                <li><strong>Correo electrónico: </strong>chikinspain@gmail.com</li>
            </ul>
            ...
            <p>Los contenidos de este sitio web, incluidos, a título enunciativo, textos, imágenes, gráficos, logotipos y otros, son propiedad de Chikin Wave SL, o de terceros que han autorizado su uso. Todos los derechos están reservados. Cualquier uso no autorizado de los mismos será considerado un incumplimiento de los derechos de propiedad intelectual o industrial.</p>
            <h2>Exclusión de garantías y responsabilidad</h2>
            <p>Chikin Wave SL no se hace responsable, en ningún caso, de los daños y perjuicios de cualquier naturaleza que pudieran ocasionar, a título enunciativo, errores u omisiones en los contenidos, falta de disponibilidad del sitio web o la transmisión de virus o programas maliciosos o lesivos en los contenidos, a pesar de haber adoptado todas las medidas tecnológicas necesarias para evitarlo.</p>
            <h2>Modificaciones</h2>
            <p>Chikin Wave SL se reserva el derecho de realizar sin previo aviso las modificaciones que considere oportunas en su sitio web, pudiendo cambiar, suprimir o añadir tanto los contenidos y servicios que se presten a través de la misma como la forma en la que éstos aparezcan presentados.</p>
        </div>
